...
**Challenges in transforming a 20 years old embedded robot controller software design to a modern modular design and using agile development practices** - TBD
